...
export const mockApiResponse: ApiResponse = {
  odds: `${mockRawEvent.id},${mockRawEvent.sportId},${
    mockRawEvent.competitionId
  },${new Date(mockRawEvent.startTime).getTime()},${
    mockRawEvent.homeCompetitorId
  },${mockRawEvent.awayCompetitorId},${mockRawEvent.statusId},${
    mockRawEvent.scores
  }\n`,
};
...
export const createFetchResponse = <T extends object>(
  data: T,
  status = 200,
): Response => {
